...
public class CucumberJavaScenarioRunConfigurationProducer extends CucumberJavaFeatureRunConfigurationProducer {
    ...
    public CucumberJavaScenarioRunConfigurationProducer(ConfigurationFactory configurationFactory) {
        super(configurationFactory);
    }

    public CucumberJavaScenarioRunConfigurationProducer(ConfigurationType configurationType) {
