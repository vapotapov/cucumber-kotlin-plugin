...
public class CucumberJavaFeatureRunConfigurationProducer extends CucumberJavaRunConfigurationProducer {
    ...
    public CucumberJavaFeatureRunConfigurationProducer(ConfigurationFactory configurationFactory) {
        super(configurationFactory);
    }

    public CucumberJavaFeatureRunConfigurationProducer(ConfigurationType configurationType) {
