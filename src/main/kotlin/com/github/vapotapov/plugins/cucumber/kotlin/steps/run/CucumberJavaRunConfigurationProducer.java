...
import static com.github.vapotapov.plugins.cucumber.kotlin.utils.CucumberVersionUtil.*;
...
public abstract class CucumberJavaRunConfigurationProducer extends JavaRunConfigurationProducerBase<CucumberJavaRunConfiguration> implements Cloneable {
    ...
    public CucumberJavaRunConfigurationProducer(ConfigurationFactory configurationFactory) {
        super(configurationFactory);
    }

    public CucumberJavaRunConfigurationProducer(ConfigurationType configurationType) {
    ...
    private static void addPackagesOfMethods(final Collection<PsiMethod> psiMethods, final Set<String> packages) {
        for (final PsiMethod psiMethod : psiMethods) {
            ...
            if (StringUtil.isNotEmpty(packageName)) {
                CucumberKotlinUtil.addGlue(packageName, packages);
            }
        }
    }
